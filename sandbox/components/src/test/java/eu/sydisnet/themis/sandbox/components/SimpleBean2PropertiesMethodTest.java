 ...
 */
public class SimpleBean2PropertiesMethodTest
{
    /**
     * Logger.
     */
    ...
    public static void startRuntime()
    {
        ...
        // Background
        // Given a portable configuration
        Properties containerConfig = new Properties();
        containerConfig.put(EJBContainer.MODULES, Paths.get("target", "classes").toFile());

        // And a started JavaEE / Jakarta EE Runtime;
        container = EJBContainer.createEJBContainer(containerConfig);
    }
